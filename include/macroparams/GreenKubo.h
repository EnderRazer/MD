...
private:
  /* data */
public:
  inline const double getACFV(System &sys,std::vector<double> &init_vel_x, std::vector<double> &init_vel_y, std::vector<double> &init_vel_z) const {
  ...
  inline const double getACFP(System &sys, double &init_press_tensor_xy,double &init_press_tensor_yz,double &init_press_tensor_zx) const {
